...
for o in range(len(l)): #прогоняем цикл столько раз, сколько элементов у нас в списке l (это нужно, чтобы график мог построиться)
    ...
    h+=1    #прибавляем к h 1 чтобы начать считать колл-во следующих элементов
